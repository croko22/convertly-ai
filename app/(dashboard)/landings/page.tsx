...
import { ExternalLink, Calendar, Trash, Trash2 } from "lucide-react";
        ...
        <div className="container mx-auto py-10 px-4 md:px-8 max-w-7xl font-sans">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/trash">
                        <Button variant="outline" className="gap-2 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
            ...
            {landingPages.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {landingPages.map((page) => (
                        <Card key={page.id} className="flex flex-col h-full hover:shadow-md transition-shadow dark:bg-zinc-900/50 dark:border-zinc-800 group relative">
                            {/* Trash Button */}
                            <TrashButton courseId={page.courseId} />
